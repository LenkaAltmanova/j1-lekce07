...
public class Svatky {
  ...
  public boolean jeVSeznamu(String jmeno) {
    return svatky.containsKey(jmeno); //returns true or false
  }
  ...
  public int getPocetJmen() {
    return svatky.keySet().size(); //keyset vrátí množinu jmen, všech klíčů a size ji spočítá
  }
